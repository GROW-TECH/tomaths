...
const Sidebar = ({ currentPage, onPageChange }: SidebarProps) => {
  const menuItems = [
    { id: "images" as Page, label: "Banner Images", icon: BookOpen },
    ...
    { id: "exam title" as Page, label: "Exam Titles", icon: BookOpen },
    { id: "courses" as Page, label: "Exams", icon: BookOpen },
    { id: "payments" as Page, label: "Payments", icon: DollarSign },
    { id: "users" as Page, label: "Users", icon: Users },
    { id: "Settings" as Page, label: "Settings", icon: BookOpen },
  ];
